...
class EmployeeAdapter(
    ...
    private var onItemClickListener: OnItemClickListener) : RecyclerView.Adapter<EmployeeHolder>() {
...
//        val binding = DataBindingUtil.inflate<EmployeeItemBinding>(
//            inflater, R.layout.employee_item, parent, false
//        )
